...
Core has no built-in rule bag. Language/framework rules live in `@code-invariants/typescript` and `@code-invariants/react`. Installing a plugin does not enable its rules.
